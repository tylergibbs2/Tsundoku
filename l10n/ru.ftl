...
edit-webhook-form-name-tt = Имя Webhook, только для отображения.
edit-webhook-form-name-field = Имя

edit-webhook-form-service-tt = Служба, на которую отправляется Webhook.
edit-webhook-form-service-field = Сервис

edit-webhook-form-url-tt = URL-адрес, на который отправляется Webhook.
edit-webhook-form-url-field = URL-адрес

edit-webhook-form-content-tt = Формат, в котором будет отправлено содержимое.
edit-webhook-form-content-name = Формат содержимого

edit-webhook-form-cancel-button = Отменить
