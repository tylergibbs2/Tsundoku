...
async def test_retrieve_all_libraries(app: MockTsundokuApp, caplog: LogCaptureFixture):
...
async def test_library_folder_is_path(app: MockTsundokuApp, caplog: LogCaptureFixture):
    caplog.set_level(logging.ERROR, logger="tsundoku")
