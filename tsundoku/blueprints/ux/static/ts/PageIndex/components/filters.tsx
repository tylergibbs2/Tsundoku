...
export const Filters = ({
  ...
  const cardView = () => {
    if (viewType !== "cards") setViewType("cards");
  };
  ...
  return (
    <div
      className="columns pb-3 background-gradient"
      style={{
        position: "sticky",
        top: "0",
        zIndex: "5",
    ...
    >
      <div className="column is-7">
        <div className="tags are-medium">
          <span
            className={
              "noselect tag mr-1 is-clickable " +
              (isFilter("current") ? "is-success" : "")
            }
          ...
          <span
            className={
              "noselect tag mr-1 is-clickable " +
              (isFilter("unreleased") ? "is-info" : "")
            }
            onClick={filterUnreleased}
          >
            {_("status-unreleased")}
          </span>
          <span
            className={
              "noselect tag is-clickable " +
              (isFilter("upcoming") ? "is-primary" : "")
            }
          ...
          <div className="field-body">
            ...
            <div className="field">
              <div className="control has-icons-left">
                <input
                  type="text"
                  className="input is-pulled-right"
...
const SortDropdown = ({
  ...
  const sortKeyTitle = () => {
    if (sortKey !== "title") setSortKey("title");
  };

  const sortKeyUpdate = () => {
    if (sortKey !== "update") setSortKey("update");
  };

  const sortKeyAdded = () => {
    if (sortKey !== "dateAdded") setSortKey("dateAdded");
  };
      ...
      <div className="dropdown-menu">
        <div className="dropdown-content">
          ...
          <a
            onClick={sortDirAsc}
            className={
              "dropdown-item has-text-centered " +
              (sortDirection === "+" ? "is-active" : "")
            }
          >
            <div className="columns">
              <div className="column is-2">{_("sort-dir-asc")}</div>
          ...
          >
            <div className="columns">
              <div className="column is-2">{_("sort-dir-desc")}</div>
              <div className="column is-2 is-offset-8">
                <span className="icon is-small">
                  <IonIcon name="arrow-down" />
                </span>
